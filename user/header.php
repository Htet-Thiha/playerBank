  ...
  <nav id="Nav" class="Nav NavColor navbar navbar-expand-lg fixed-top">
    ...
    <div class="container-fluid px-5">
        ...
        <ul class="roboto-serif-regular navbar-nav me-auto mb-2 mb-lg-0 " id="unactive-text" >
          <li class="nav-item">
            <a href="../index.php">
              <div class="roboto-serif-bold d-flex align-items-center mt-2 mt-lg-0 fs-2 navbar-brand " style="color: #475569;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" >
          ...
          <ul class="roboto-serif-regular navbar-nav me-auto mb-2 mb-lg-0 m-auto " >
            ...
            <li class="nav-item mx-4 ">
              <a class="nav-link " id="" style="color: #475569;" href="../index.php">Home</a>
            </li>
            ...
            <li class="nav-item mx-4">
                ...
                aria-expanded="false">
                  ...
                  aria-labelledby="navbarDropdownMenuLink" >
                    ...
                    <li><a class="dropdown-item" href="<?php echo $isUserLoggedIn?"userWallet.php":"../login.php";?>">My Wallet</a></li>
                    <li><a class="dropdown-item" href="<?php echo $isUserLoggedIn?"cashIn.php":"../login.php";?>">Cash In</a></li>
                    <li><a class="dropdown-item" href="<?php echo $isUserLoggedIn?"cashOut.php":"../login.php";?>">Cash Out</a></li>
                    <li><a class="dropdown-item" href="<?php echo $isUserLoggedIn?"withDraw.php":"../login.php";?>">Withdraw</a></li>
                    <li><a class="dropdown-item" href="<?php echo $isUserLoggedIn?"transfer.php":"../login.php";?>">Transfer</a></li>
        ...
        <div class="d-flex align-items-center" id="unactive-text">
          ...
          <div class="dropdown <?php echo !$isUserLoggedIn?"d-none":""?>" id="active-text">
              ...
              <ul
                ...
                <li><a class="dropdown-item" href="./userDetail.php">Account Detail</a></li>
                <li><a class="dropdown-item" href="./userTransaction.php">Transcitions</a></li>
                <li><a class="dropdown-item" href="./userHistory.php">History</a></li>
            ...
            <!-- login logout btn -->
            <a href="logout.php" class="btn btn-danger px-2 <?php echo !$isUserLoggedIn?"d-none":""?>">LOGOUT</a>
            <a href="register.php" class="btn btn-primary px-2 <?php echo $isUserLoggedIn?"d-none":""?>">REGISTER</a>
