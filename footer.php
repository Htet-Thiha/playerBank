    ...
    <div class="container text-center text-md-start">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Game 1</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Game 2</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Game 3</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Game 4</a>
          </p>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Mini games</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Back to homepage</a>
          </p>
        </div>
        <!-- Grid column -->
