...
if(isset($_GET['action'])&& $_GET['action']=='delete')
{
    ...
    // $adminid=3;
    $log="deleted ".$username."(id ".$id.") from userlist";
...
if(isset($_GET['action']) && $_GET['action']=='banActive'){
    ...
    banActivate($id,'user','userid',$adminid,$username);
    echo '<script type="text/javascript">
        window.history.back();
    </script>';
};
                                    ...
                                    if($_SESSION['role']>2){
                                        ...
                                        <td>
                                            ...
                                            <div class='d-flex'>
                                                ...
                                                href='userlist.php?action=delete&id={$id}&userName={$username}&adminid={$_SESSION['adminid']}'
                                                onclick='return confirm('Are you sure?')'
                                                style='background-color:hsl(286, 61%, 92%) ; margin-left:20px'>DEL</a>

                                                <a data-mdb-ripple-init type='button' class='btn'
                                                href='userlist.php?action=banActive&id={$id}&userName={$username}&adminid={$_SESSION['adminid']}'
                                                style='background-color:hsl(286, 61%, 92%) ; margin-left:20px'>B/A</a>    

                                                <a data-mdb-ripple-init type='button' class='btn'
                                                href='userLog.php?action=userLog&id={$id}&adminid={$_SESSION['adminid']}'
                                                style='background-color:hsl(286, 61%, 92%) ; margin-left:20px'>User Log</a>  
                                            </div>                                                                                                 
                                    ...
                                    if($_SESSION['role']>2){
                                        ...
                                        <td>
                                            ...
                                            <div class='d-flex'>
                                                ...
                                                <a data-mdb-ripple-init type='button' class='btn'
                                                href='userLog.php?action=userLog&id={$id}&adminid={$_SESSION['adminid']}'
                                                style='background-color:hsl(286, 61%, 92%) ; margin-left:20px'>UserLog</a>  
                                            </div>                                                                                                 
