...
if(isset($_GET['action'])&& $_GET['action']=='delete')
{
    ...
    $log="deleted ".$username."(id ".$id.") from admin List";
...
if(isset($_GET['action']) && $_GET['action']=='banActive'){
    ...
    banActivate($id,'admin','adminid',$adminid,$username);
    echo '<script type="text/javascript">
        window.history.back();
    </script>';
};
...
<body>
    ...
    <div class="d-flex flex-column m-5 p-5" > 
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="./registerForm.php" class="btn btn-primary">Creat New Admin</a>
            ...
            <form action="adminList.php" class="searchbox rounded d-flex" method="POST">
                                    ...
                                    if($_SESSION['role']==1){
                                        ...
                                        <td>
                                            ...
                                            <div class='d-flex'>
                                                ...
                                                href='adminList.php?action=delete&id={$id}&adminName={$username}&adminid={$_SESSION['adminid']}'
                                                onclick='return confirm('Are you sure?')'
                                                style='background-color:hsl(286, 61%, 92%) ; margin-left:20px'>DEL</a>

                                                <a data-mdb-ripple-init type='button' class='btn'
                                                href='adminList.php?action=banActive&id={$id}&adminName={$username}&adminid={$_SESSION['adminid']}'
                                                style='background-color:hsl(286, 61%, 92%) ; margin-left:20px'>B/A</a>    

                                                <a data-mdb-ripple-init type='button' class='btn'
                                                href='upgrade.php?action=upgrade&id={$id}'
                                                style='background-color:hsl(286, 61%, 92%) ; margin-left:20px'>Upgrade</a>  
                                            </div>                                                                                                 
