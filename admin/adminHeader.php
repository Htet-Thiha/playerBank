    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center" id="unactive-text">
          ...
          <div class="roboto-serif-bold textColor d-flex align-items-center  mt-lg-0 fs-2 navbar-brand text-light rounded-circle">
            ...
            <a href="./adminDetail.php"><img src="<?php echo $_SESSION['adminPhoto']?>" height="35" alt="" class=" rounded shadow-lg" /></a>
          </div>
        ...
        <div class="dropdown" id="active-text">
            <a
              ...
              role="button"
              aria-expanded="false">
              <i class="fas fa-bars fa-2x" style="color:hsl(286, 61%, 86%)"></i>
            </a>
            ...
            <ul
              ...
              <li><a class="dropdown-item" href="./adminDashboard.php">Main board</a></li>
              <li><a class="dropdown-item" href="./userlist.php">User list</a></li>
              <li><a class="dropdown-item" href="./userCashIn.php">User Cash In</a></li>
              <li><a class="dropdown-item" href="adminList.php">Admin list</a></li>
              <li><a class="dropdown-item" href="refillpage.php">Refill Points</a></li>
              <li><a class="dropdown-item" href="./newProduct.php">Add Product</a></li>
              <li><a class="dropdown-item" href="./adminLogout.php"><div class="btn btn-danger">LOGOUT</div></a></li>
