  ...
  <section >
    <div class="container text-center text-md-start">
      ...
      <div class="row mt-3">
        ...
        <!-- Grid column -->
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4 hide">
          <!-- Links -->
          <h6 class="text-uppercase fw-bold mb-4">
            Most Buying
          </h6>
          <p>
            <a href="./shopDetail.php?id=1" class="text-reset">Mobile Legends</a>
          </p>
          <p>
            <a href="./shopDetail.php?id=2" class="text-reset">PUBG</a>
          </p>
        </div>
        <!-- Grid column -->

        <!-- Grid column -->
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4 hide">
          <!-- Links -->
          <h6 class="text-uppercase fw-bold mb-4">
            Useful links
          </h6>
          ...
          <p>
            <a href="<?php echo $isUserLoggedIn?"./shopList.php":"../login.php";?>" class="text-reset">Shop</a>
          </p>
          <p>
